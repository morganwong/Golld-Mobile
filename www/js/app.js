...
NetEvtLinks = {
  ...
  "rest": {
    "AccountController": {
      ...
      "loginp": "" + AppProps.root + "/accounts/loginp",
...
var AccountGolldView,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

AccountGolldView = (function(_super) {
  __extends(AccountGolldView, _super);

  function AccountGolldView() {
    this.init = __bind(this.init, this);
    AccountGolldView.__super__.constructor.call(this, "AccountGolldView");
    this.template = this.tmpl;
    this.evtHandler = new AccountGolldEvtHandler(this);
  }

  AccountGolldView.prototype.init = function(data) {
  ...
  AccountGolldView.prototype.tmpl = function(data) {
    return "<div class=\"has-header\">\n\n</div>";
  };

  return AccountGolldView;

})(BaseView);
var LoginCreateGolldView,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

LoginCreateGolldView = (function(_super) {
  __extends(LoginCreateGolldView, _super);

  function LoginCreateGolldView() {
    this.create = __bind(this.create, this);
    this.login = __bind(this.login, this);
    this.init = __bind(this.init, this);
    LoginCreateGolldView.__super__.constructor.call(this, "LoginCreateGolldView");
    this.template = this.tmpl;
    this.evtHandler = new LoginCreateGolldEvtHandler(this);
    this.evtHandler.net.bindEvtToLink('login', NetEvtLinks.rest.AccountController.login);
    this.evtHandler.net.bindEvtToLink('create', NetEvtLinks.rest.AccountController.create);
  }

  LoginCreateGolldView.prototype.init = function(data) {
    var ctx;
    this.injectUI({
      mobileBackBtn: function() {
        return UI.views.init("SplashView");
    ...
    return $('button').click(function() {
      switch ($(this).attr('id')) {
        case "loginbutton":
          return ctx.login();
        case "switchtocreatebutton":
          $('#loginform').hide();
          return $('#createform').show();
        case "createaccountbutton":
          return ctx.create();
        case "switchtologinbutton":
          $('#createform').hide();
  ...
  LoginCreateGolldView.prototype.login = function() {
    return this.evtHandler.net.verbose(true).body({
      username: $('#loginusername').val(),
      password: $('#loginpassword').val()
    }).post("login");
  };

  LoginCreateGolldView.prototype.create = function() {
    return this.evtHandler.net.verbose(true).body({
  ...
  LoginCreateGolldView.prototype.tmpl = function(data) {
...
SplashView = (function(_super) {
  ...
  function SplashView() {
    this.init = __bind(this.init, this);
    SplashView.__super__.constructor.call(this, "SplashView");
    this.template = this.tmpl;
    this.evtHandler = new SplashEvtHandler(this);
  }

  SplashView.prototype.init = function(data) {
    var ctx;
    this.injectUI({
      mobileBackBtn: function() {
    ...
    ctx = this;
    $('golldtab').click(function() {
      $('#splash').hide();
      if ($(this).text() === "Golld") {
        $('#golldtab').css("display", "block");
        $('#wallettab').css("display", "none");
      } else {
        $('#golldtab').css("display", "none");
        $('#wallettab').css("display", "block");
      }
      return ctx.doActive('golldtab', $(this).text(), ctx);
    });
    return $('button').click(function() {
      return trace($(this).text() + " clicked!");
    });
  };

  SplashView.prototype.doActive = function(tag, text, ctx) {
    return $('body').find(tag).each(function() {
      if ($(this).text() === text) {
        return $(this).html("<strong>" + $(this).text() + "</strong>");
      } else {
        return $(this).html(ctx.removeBold($(this).text()));
      }
    });
  };

  SplashView.prototype.removeBold = function(str) {
    if (str.indexOf("<strong>" === -1)) {
      return str;
    } else {
      str = str.replaceAll("<strong>", "");
      return str = str.replaceAll("</strong>", "");
    }
  };

  SplashView.prototype.tmpl = function(data) {
    return "<div class=\"has-header\">\n\n  <div id='splash'>\n    <img src='img/CoinGollldLogo150px.png'/>\n    <p>Opening Message Here...</p>\n  </div>\n\n  <div id='golldtab'>\n    <div class='padding10'>\n      <img src='img/CoinGollldLogo150px.png'/>\n      <h2>Welcome to Golld</h2>\n      <h4 style='font-style: italic'>Own Gold bullion, without buying a vault</h4>\n      <hr>\n    </div>\n    <button class='button button-full button-dark' onclick=\"UI.views.init('LoginCreateGolldView')\">Login / Create Account</button>\n    <button class='button button-full button-dark'>Buy Golld</button>\n    <button class='button button-full button-dark'>Info</button>\n  </div>\n\n  <div id='wallettab'>\n    Wallet\n  </div>\n\n  <div id='footer' class='tabs'>\n    <golldtab class='tab-item'>Golld</golldtab>\n    <golldtab class='tab-item'>Wallet</golldtab>\n  </div>\n</div>";
  };
