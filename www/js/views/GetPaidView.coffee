class GetPaidView extends BaseView
  constructor: ()->
    super("GetPaidView")
      ...
      if currentTokens.golldvouchers?
        ...
        for k of currentTokens.golldvouchers
          ...
          if currentTokens.golldvouchers[k]
            ...
            $('#tokenslist').html k + ": <span id='" + k + "_amountspan'>" + bal + "</span><br>"
  ...
  tmpl: (data) ->
    """
      <div class='bar bar-header'>
        <h1 class='title' id='balanceh1'>Get Paid</h1>
      </div>
      ...
      <div id='walletcontent' class='splash headerabove'>
        ...
        <ul class="list">
          <li class="item" style='line-height: 160%'>
            <h3>Wallet Address - Have funds sent to your address</h3>
            <br>
            <p id='address'></p>
            <br>
